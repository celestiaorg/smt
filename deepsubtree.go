...
// UpdateBranch updates a branch in the tree.
// The branch must be generated by smt.ProveForRoot, and should be verified by VerifyProof first.
// Set updateRoot to true if the current root of the tree should be updated.
func (dsmst *DeepSparseMerkleSubTree) UpdateBranch(proof SparseMerkleProof, key []byte, value []byte, updateRoot bool) ([]byte, error) {
